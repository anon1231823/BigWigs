...
L.compartmentMenu_desc = "Al desactivar esta opción, BigWigs aparecerá en el menú de compartimiento de addons. Recomendamos dejar esta opción activada."
...
-- Sharing.lua
L.import = "Importar"
L.import_info = "Después de ingresar la cadena de importación, puedes seleccionar qué opciones quieres importar.\nSi no hay opciones disponibles en la cadena de importación estas no podrán ser seleccionadas.\n\n|cffff4411Este importe solo afectará las opciones generales y no afecta ninguna opción especifica de jefes.|r"
L.import_info_active = "Elige que partes te gustaría importar y luego presiona el botón de importación."
...
L.keystoneTeleportInCombat = "No puedes teletransportarse aquí mientras estás en combate."
