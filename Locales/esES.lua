...
L.proximity_desc = "Muestra la ventana de proximidad cuando sea apropiada para este encuentro, listando los jugadores que están demasiado cerca de ti."
L.adds = "Esbirros"
...
L.guildRelease = "Estás usando la versión de BigWigs %d hecha para tu hermandad, basada en la versión %d del addon oficial."
...
L.oldVersionsInGroup = "Alguien de tu grupo tiene una |cffff0000versión antigua|r de BigWigs. Para más detalles escribe /bwv."
L.upToDate = "Al día:"
...
L.compartmentMenu_desc =  "Desactivar esta opción hará que BigWigs no se muestre en el menú de compartimiento de addons. Recomendamos dejar esta opción activada."
...
L.PULSE = "Pulso"
L.PULSE_desc = "Para complementar el flash de pantalla, también puedes tener un icono relacionado con esta habilidad específica que se mostrará momentáneamente en el medio de la pantalla para tratar de atraer tu atención."
L.MESSAGE_desc = "La mayoría de las habilidades de los encuentros se presentan con uno o más mensajes que BigWigs mostrará en tu pantalla. Si desactivas esta opción, ningún mensaje de esta opción, si lo hay, será mostrado."
...
L.PROXIMITY_desc = "Algunas habilidades requieren que te separes. La ventana de proximidad se ajustará específicamente para esa habilidad para que sepas de un vistazo si estás a salvo o no."
L.ALTPOWER = "Indicador de poder alternativo"
...
L.CASTBAR_COUNTDOWN_desc = "Si está activo, una cuenta atrás vocal y visual se añadirá para los últimos 5 segundos de las barras de lanzamiento."
L.INFOBOX = L.infobox
...
L.ME_ONLY_EMPHASIZE_desc = "Habilitar esto enfatizará cualquier mensaje asociado con esta habilidad SOLO si se lanza sobre ti, mostrándolo más grande y visible."
...
L.nameplate_settings_import_desc = "Importa todas las configuraciones de placas de nombre."
L.nameplate_settings_export_desc = "Exporta todas las configuraciones de placas de nombre."
...
L.position_import_countdown_desc = "Importa la posición (anclajes) de la cuenta atrás."
...
L.position_export_countdown_desc = "Exporta la posición (anclajes) de la cuenta atrás."
L.settings_import_bars_desc = "Importa las configuraciones generales de las barras, como tamaño, fuente, etc."
L.settings_import_messages_desc = "Importa las configuraciones generales de los mensajes, como tamaño, fuente, etc."
L.settings_import_countdown_desc = "Importa las configuraciones generales de la cuenta atrás, como voz, tamaño, fuente, etc."
L.settings_export_bars_desc = "Exporta las configuraciones generales de las barras, como tamaño, fuente, etc."
L.settings_export_messages_desc = "Exporta las configuraciones generales de los mensajes, como tamaño, fuente, etc."
L.settings_export_countdown_desc = "Exporta las configuraciones generales de la cuenta atrás, como voz, tamaño, fuente, etc."
L.colors_import_bars_desc = "Importa los colores de las barras."
L.colors_import_messages_desc = "Importa los colores de los mensajes."
L.color_import_countdown_desc = "Importa el color de la cuenta atrás."
L.colors_export_bars_desc = "Exporta los colores de las barras."
L.colors_export_messages_desc = "Exporta los colores de los mensajes."
L.color_export_countdown_desc = "Exporta el color de la cuenta atrás."
...
L.imported_countdown_position = "Posición de cuenta atrás"
L.imported_countdown_settings = "Configuraciones de cuenta atrás"
L.imported_countdown_color = "Color de cuenta atrás"
L.imported_nameplate_settings = "Configuraciones de Placas de Nombre"
L.imported_mythicplus_settings = "Mítica+ opciones"
L.mythicplus_settings_import_desc = "Importa todas las opciones de Mítica+."
L.mythicplus_settings_export_desc = "Exporta todas las opciones de Mítica+."
L.imported_battleres_settings = "Opciones de Battle Res"
L.battleres_settings_import_desc = "Importa todas las opciones de Battle Res."
L.battleres_settings_export_desc = "Exporta todas las opciones de Battle Res."
...
L.keystoneTeleportReady = "El hechizo de teletransporte '|cFFFFFFFF%s|r' está |cFF33FF99listo|r, haz clic para lanzarlo."
...
L.keystoneCountdownBeginsSound = "Reproduce un sonido cuando la cuenta atrás de la Mítica+ empiece"
...
L.keystoneHideGuildWarning = "Desactivar la opción de que tus miembros de hermandad vean tu piedra angular |cffff4411no está recomendado|r.\n\n¿Estás seguro de que quieres hacer esto?"
...
L.lfgTimerExplainer = "Cuando aparece la ventana emergente del BDG, BigWigs creará una barra diciéndote cuánto tiempo tienes para aceptar la cola.\n\n"
...
L.time = "Tiempo"
L.timeDesc = "Muestra u oculta el tiempo restante en las barras."
...
L.blockDungeonPopupsDesc = "Los carteles emergentes que aparecen cuando entras a una mazmorras pueden contener texto que es muy largo. Activar esta opción los bloqueara directamente."
...
L.useIconsDesc = "Muestra iconos junto a los mensajes."
...
L.keepAspectRatioDesc = "Mantiene la relación de aspecto del icono 1:1 en lugar de estirarlo para que se ajuste al tamaño del marco."
...
L.zoom = "Zoom"
L.zoomDesc = "Hace zoom en la textura del icono."
...
L.showNumbersDesc = "Muestra números en el icono."
...
L.showCooldownSwipeDesc = "Muestra un barrido en el icono cuando el tiempo de reutilización está activo."
L.showCooldownEdge = "Mostrar Borde"
L.showCooldownEdgeDesc = "Muestra un borde en el tiempo de reutilización cuando está activo."
L.inverse = "Invertir"
L.inverseSwipeDesc = "Invierte las animaciones de tiempo de reutilización."
L.glow = "Brillo"
L.enableExpireGlow = "Habilitar brillo al expirar"
L.enableExpireGlowDesc = "Muestra un brillo alrededor del icono cuando el tiempo de reutilización ha expirado."
...
L.resetNameplateIconsDesc = "Restablece todas las opciones relacionadas con los iconos de las placas de nombre."
L.nameplateTextSettings = "Configuraciones de texto"
L.fixate_test = "Prueba de fijación" -- Text that displays to test on the frame
L.resetNameplateTextDesc = "Restablece todas las opciones relacionadas con el texto de las placas de nombre."
...
L.tooltip = "Tooltip"
L.tooltipDesc = "Muestra/oculta la descripción del hechizo si la ventana de proximidad está ligada a una habilidad del jefe."
...
L.combatLogDesc = "Inicia automáticamente el registro del combate cuando se inicia un temporizador de pull y finalizarlo cuando termina el encuentro."
